...
namespace WTools
{
    public partial class EditProduct : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd1 = new SqlCommand($"UPDATE [Products] SET [MB051] ={textBox5.Text} ,[MB002]='{textBox2.Text}',[MB003]='{textBox3.Text}',[MB004]='{textBox4.Text}',[MB064] = {textBox6.Text},[SupId]='{dt.Rows[combbox1.SelectedIndex][0]}',[CostPrice]={textBox7.Text} WHERE [MB001]='{textBox1.Text}'", conn1);
            cmd1.Connection.Open();
            if (DR == null)
            { 
                cmd1.CommandText = $"INSERT INTO Products([MB001],[MB002],[MB003],[MB004],[MB051],[MB064],[SupId],[CostPrice]) VALUES('{textBox1.Text}','{textBox2.Text}','{textBox3.Text}','{textBox4.Text}',{textBox5.Text},{textBox6.Text},'{dt.Rows[combbox1.SelectedIndex][0]}',{textBox7.Text})";                
            }
